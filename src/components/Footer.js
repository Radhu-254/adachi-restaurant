...
const Footer = () => {
  ...
  return (
    <footer className='relative top-96 z-20 bg-dark lg:bg-transparent lg:min-h-[620px] lg:bg-footer lg:bg-center lg:bg-no-repeat pt-20 lg:pt-32 mt-10'>
                  ...
                  return (
                    <div className='capitalize' key={index}>
                      <div>
                        ...
                        <div className='text-[20px] text-cyan-500'>
                          {item.hours}
                        </div>
                      </div>
                    </div>
